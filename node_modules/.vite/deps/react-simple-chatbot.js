...
// fireJetReact/node_modules/react-simple-chatbot/node_modules/react/cjs/react.development.js
var require_react_development = __commonJS({
  "fireJetReact/node_modules/react-simple-chatbot/node_modules/react/cjs/react.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
// fireJetReact/node_modules/react-simple-chatbot/node_modules/react/index.js
var require_react2 = __commonJS({
  "fireJetReact/node_modules/react-simple-chatbot/node_modules/react/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// fireJetReact/node_modules/stylis/stylis.min.js
var require_stylis_min = __commonJS({
  "fireJetReact/node_modules/stylis/stylis.min.js"(exports, module) {
    !function(e) {
...
// fireJetReact/node_modules/stylis-rule-sheet/index.js
var require_stylis_rule_sheet = __commonJS({
  "fireJetReact/node_modules/stylis-rule-sheet/index.js"(exports, module) {
    (function(factory) {
...
// fireJetReact/node_modules/@emotion/unitless/dist/unitless.browser.esm.js
...
// fireJetReact/node_modules/styled-components/node_modules/memoize-one/dist/memoize-one.esm.js
...
// fireJetReact/node_modules/@emotion/memoize/dist/memoize.browser.esm.js
function memoize(fn) {
  var cache = {};
  return function(arg) {
...
// fireJetReact/node_modules/@emotion/is-prop-valid/dist/is-prop-valid.browser.esm.js
...
// fireJetReact/node_modules/is-what/dist/index.esm.js
...
// fireJetReact/node_modules/merge-anything/dist/index.esm.js
...
// fireJetReact/node_modules/styled-components/dist/styled-components.browser.esm.js
...
// fireJetReact/node_modules/react-simple-chatbot/dist/react-simple-chatbot.js
var require_react_simple_chatbot = __commonJS({
  "fireJetReact/node_modules/react-simple-chatbot/dist/react-simple-chatbot.js"(exports, module) {
    !function(e, t) {
      ...
      return function(e2) {
        ...
        var n = /* @__PURE__ */ function(e3, t3) {
          return { parse: function(t4, r2) {
            ...
            for (var a, s = /* @__PURE__ */ new Map(), u = [], c = [], l = o2 && typeof o2 == typeof u ? function(e5, t4) {
              if ("" === e5 || -1 < o2.indexOf(e5)) return t4;
              ...
              return o3;
            }; p < u.length; p++) a = true, c[p] = JSON.stringify(u[p], f, i2);
            return "[" + c.join(",") + "]";
          } };
          function n2(e4, t4) {
            return t4;
        ...
        e2.exports = function(e3, t3) {
          ...
          for (var o = ""; e3--; ) o += r.charAt(Math.floor(Math.random() * r.length));
          return o;
        };
      }, function(e2, t2, n) {
        "use strict";
        ...
        e2.exports = function(e3, t3, n2, o, i, a, s, u) {
          if (r(t3), !e3) {
            var c;
            if (void 0 === t3) c = new Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");
            else {
        ...
        var R = function(e3) {
          function t3() {
            ...
            for (var a3 = arguments.length, s2 = new Array(a3), u2 = 0; u2 < a3; u2++) s2[u2] = arguments[u2];
        ...
        var xe = { parse: function(e3) {
          var t3 = [];
          if (e3.user) t3 = be;
          else if (e3.message) t3 = he;
          else if (e3.options) t3 = ge;
          else if (e3.component) t3 = ye;
          else {
            if (!e3.update) throw new Error("The step ".concat(Object(me.stringify)(e3), " is invalid"));
            t3 = ve;
          }
          for (var n2 = 0, r2 = t3.length; n2 < r2; n2 += 1) {
            var o2 = t3[n2], i2 = o2.key, a2 = o2.types, s2 = o2.required;
            if (!e3[i2] && s2) throw new Error("Key '".concat(i2, "' is required in step ").concat(Object(me.stringify)(e3)));
            if (e3[i2] && "any" !== a2[0] && a2.indexOf(Se(e3[i2])) < 0) throw new Error("The type of '".concat(i2, "' value must be ").concat(a2.join(" or "), " instead of ").concat(Se(e3[i2])));
          }
          var u2 = t3.map(function(e4) {
            return e4.key;
          });
          for (var i2 in e3) u2.indexOf(i2) < 0 && (console.error("Invalid key '".concat(i2, "' in step '").concat(e3.id, "'")), delete e3[i2]);
          return e3;
        }, checkInvalidIds: function(e3) {
          for (var t3 in e3) {
            var n2 = e3[t3], r2 = e3[t3].trigger;
            if ("function" != typeof r2) {
              if (n2.options) for (var o2 = n2.options.filter(function(e4) {
                return "function" != typeof e4.trigger;
              }).map(function(e4) {
                return e4.trigger;
              }), i2 = 0, a2 = o2.length; i2 < a2; i2 += 1) {
                var s2 = o2[i2];
                if (s2 && !e3[s2]) throw new Error("The id '".concat(s2, "' triggered by option ").concat(i2 + 1, " in step '").concat(e3[t3].id, "' does not exist"));
              }
              else if (r2 && !e3[r2]) throw new Error("The id '".concat(r2, "' triggered by step '").concat(e3[t3].id, "' does not exist"));
            }
          }
        } }, Oe = function(e3, t3) {
          var n2 = Object(me.parse)(Object(me.stringify)(t3));
          for (var r2 in n2) for (var o2 = 0, i2 = n2[r2].length; o2 < i2; o2 += 1) n2[r2][o2].component && (n2[r2][o2].component = n2[r2][o2].id);
        ...
        var tt = null, nt = function() {
          ...
          return et(e3, null, [{ key: "isSupported", value: function() {
            ...
            for (var t3 = "", n2 = "", r2 = e4.resultIndex; r2 < e4.results.length; r2 += 1) e4.results[r2].isFinal ? (n2 += e4.results[r2][0].transcript, this.onFinal(n2)) : (t3 += e4.results[r2][0].transcript, this.onChange(t3));
          } }, { key: "setState", value: function(e4) {
            this.state = Qe({}, this.state, e4);
          } }, { key: "setup", value: function() {
            if (!e3.isSupported()) return this;
        ...
        var St = function(e3) {
          function t3(e4) {
            ...
            return function(e5, t4) {
              ...
              if (e5 && e5.value && (l2.value = e5.value), e5 && e5.hideInput && (l2.hideInput = e5.hideInput), e5 && e5.trigger && (l2.trigger = n3.getTriggeredStep(e5.trigger, e5.value)), f2) n3.handleEnd();
                ...
                if (h2.message) h2.message = n3.getStepMessage(h2.message);
                else if (h2.update) {
                  var g2 = h2;
                  if ((h2 = bt({}, s2[g2.update])).options) for (var y2 = 0, v2 = h2.options.length; y2 < v2; y2 += 1) h2.options[y2].trigger = g2.trigger;
                  else h2.trigger = g2.trigger;
                }
              ...
              if ((n3.isInputValueEmpty() || t4) && r3) return n3.recognition.speak(), void (t4 || n3.setState({ speaking: true }));
            ...
            var O2 = function(e5, t5) {
              ...
              if (r3 && c3) try {
                ...
                if (!p3 || !p3.end) {
                  ...
                  if (m3 && delete l3.currentStep.rendered, !y3 && !v3) if (m3) for (var x3 = 0; x3 < m3.length; x3 += 1) l3.currentStep.options[x3].trigger = i4[S3].options[x3].trigger;
                  else l3.currentStep.trigger = i4[S3].trigger;
